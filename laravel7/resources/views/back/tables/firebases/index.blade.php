...
<body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="add-post" method="post">
                        ...
                        <div class="mb-3">
                            <label for="update-content" class="form-label">file</label>
                            <input type="file" class="inputFile form-control" name="pdf_file" id="fileInp">
                        </div>
                        
                        <div class="mb-3">
                            <label for="update-content" class="form-label">file name</label>
                            <input type="text" class="form-control" name="pdf"  id="pdf" >
                        </div>
                        
                        
                        <button type="button" onclick="uploadImage();" id="add-submit" class="btn btn-primary">Submit</button>
    ...
    <script type="text/javascript">
        ...
        //     fileItem  = document.getElementById("fileInp").files[0];
        ...
        // get post data
        database.ref("documents").on('value', function(snapshot) {
            ...
            $('#add-submit').on('click', function() {
                ...
                firebase.database().ref('documents/' + createId).set({
                ...
                // const ref = firebase.database().ref('documents/' + createId);
                ...
                // const metadata = {
                    ...
                    // const task = ref.child(name).set(file, metadata);task
                    ...
                    $('body').on('click', '.update-post', function() {
                        ...
                        firebase.database().ref('documents/' + updateID).on('value', function(snapshot) {
                    ...
                    $('#update-button').on('click', function() {
                        ...
                        var updatedPost = {};
                        updatedPost['/documents/' + updateID] = postData;
                    ...
                    $('#delete-button').on('click', function() {
                        var id = $('#post-id').val();
                        firebase.database().ref('documents/' + id).remove();
